...
original_json_path = 'transforms.json'  # Update this path
transforms_data = load_json(original_json_path)

# Calculating camera angle x
...
# Extracting and processing the frame data
frames = transforms_data['frames']
total_frames = len(frames)

# Splitting and processing the frames
...
# Creating and saving JSON structures
...
# Source directory and moving images
source_dir = 'images'  # Update this path
